...
class Ui_GuideViewerDialog(object):
    def setupUi(self, GuideViewerDialog):
        ...
        self.comboBox = QtWidgets.QComboBox(parent=GuideViewerDialog)
        ...
        self.prevButton = QtWidgets.QPushButton(parent=GuideViewerDialog)
        icon = QtGui.QIcon.fromTheme("go-previous")
        self.prevButton.setIcon(icon)
        self.prevButton.setObjectName("prevButton")
        self.horizontalLayout.addWidget(self.prevButton)
        self.nextButton = QtWidgets.QPushButton(parent=GuideViewerDialog)
        icon = QtGui.QIcon.fromTheme("go-next")
        self.nextButton.setIcon(icon)
        self.nextButton.setObjectName("nextButton")
        self.horizontalLayout.addWidget(self.nextButton)
        self.dateEdit = QtWidgets.QDateEdit(parent=GuideViewerDialog)
        self.dateEdit.setCalendarPopup(True)
        self.dateEdit.setObjectName("dateEdit")
        self.horizontalLayout.addWidget(self.dateEdit)
        self.verticalLayout.addLayout(self.horizontalLayout)
        self.textBrowser = QtWidgets.QTextBrowser(parent=GuideViewerDialog)
        self.textBrowser.setObjectName("textBrowser")
        self.verticalLayout.addWidget(self.textBrowser)
        self.buttonBox = QtWidgets.QDialogButtonBox(parent=GuideViewerDialog)
        self.buttonBox.setStandardButtons(QtWidgets.QDialogButtonBox.StandardButton.Close)
        self.buttonBox.setObjectName("buttonBox")
        self.verticalLayout.addWidget(self.buttonBox)

        self.retranslateUi(GuideViewerDialog)
        self.buttonBox.clicked['QAbstractButton*'].connect(GuideViewerDialog.close) # type: ignore
