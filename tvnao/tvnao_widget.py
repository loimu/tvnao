...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.guideBrowser = QtWidgets.QTextBrowser(parent=Form)
        self.guideBrowser.setMaximumSize(QtCore.QSize(16777215, 150))
        self.guideBrowser.setFrameShape(QtWidgets.QFrame.Shape.StyledPanel)
        self.guideBrowser.setFrameShadow(QtWidgets.QFrame.Shadow.Plain)
        self.guideBrowser.setLineWidth(1)
        self.guideBrowser.setVerticalScrollBarPolicy(QtCore.Qt.ScrollBarPolicy.ScrollBarAlwaysOff)
        self.guideBrowser.setHorizontalScrollBarPolicy(QtCore.Qt.ScrollBarPolicy.ScrollBarAlwaysOff)
        self.guideBrowser.setLineWrapMode(QtWidgets.QTextEdit.LineWrapMode.NoWrap)
        self.guideBrowser.setTextInteractionFlags(QtCore.Qt.TextInteractionFlag.TextSelectableByMouse)
        ...
        self.guideFullButton = QtWidgets.QPushButton(parent=Form)
        ...
        self.guideNextButton = QtWidgets.QPushButton(parent=Form)
